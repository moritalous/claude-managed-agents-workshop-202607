...
<Aside type="tip" title="If Jina AI is unavailable">
If you hit a quota limit and cannot use the Jina AI MCP server, use the [Firecrawl](https://www.firecrawl.dev/) MCP server instead. [Troubleshooting: Jina AI is unavailable due to quota limits](/en/reference/troubleshooting/#jina-ai-is-unavailable-due-to-quota-limits) covers how to sign up and what to substitute on this page.
</Aside>
