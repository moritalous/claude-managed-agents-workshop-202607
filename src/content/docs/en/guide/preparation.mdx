...
### Adding Credits by Purchasing Them
...
### Claiming the Credits Distributed at the Workshop
...
1. Check that the email address and organization name are correct, and enter your First name and Last name.

    ![](../../guide/images/2026-08-10-02-43-40.png)

1. Under "Which Anthropic products do you currently use?", check "Claude API", then click "Submit request".
